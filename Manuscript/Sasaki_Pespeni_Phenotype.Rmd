...
title: "Cryptic genetic variation and acclimation both shape vulnerability to warming in a widespread coastal copepod"
author:
  - name: Matthew Sasaki
...
In addition to the water temperature measurements made during the collections, we also obtained continuous temperature data. In situ data was available from nearby locations for several of the sites (the Florida and Chesapeake sites)
...
Collections spanned the latitudinal gradient, with strong seasonal variation in temperature at all eight sites (Supp. Figure 2)
