...
iv_pca_exclude = iv_pca_df1 %>% 
  filter(X2 > 0.5 | (site_code == "TK" & X1 < 0.13))
...
## Old individual cross-group: removed or better aligned? 
```
...
x_pca_exclude = x_pca_df1 %>% 
  filter(X2 > 0.25 | sample %in% c("TK_early_2_01","TK_early_1_04", "TK_peak_1_09"))
